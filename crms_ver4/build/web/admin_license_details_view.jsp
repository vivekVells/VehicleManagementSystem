<%-- 
    Document   : admin_license_details_view
    Created on : Jan 12, 2015, 5:23:02 PM
    Author     : arunkumar
--%>
...
<html>
    <head>
        ...
        <title>LICENSE RENEWAL DETAILS VIEW PAGE</title>
    </head>
...
<tr><td>
  ...
  <h3 style="text-align: center;color: black"> &nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;   &nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;LICENSE RENEWAL STATUS DETAILS</h3>

        <br><br></td></tr>
        <tr><td>  <form action="license_details" method="POST">
