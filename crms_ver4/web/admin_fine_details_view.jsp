<%-- 
    Document   : admin_fine_details_view
    Created on : Jan 12, 2015, 5:21:28 PM
    Author     : arunkumar
--%>
...
<html>
    <head>
        ...
        <title>FINE DETAILS VIEW PAGE</title>
    </head>
...
<tr><td>
  ...
  <h3 style="text-align: center;color: black"> &nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;   &nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;FINE STATUS DETAILS</h3>

        <br><br></td></tr>
<tr><td>  <form action="fine_details" method="POST">
