<%-- 
    Document   : admin_details_view
    Created on : Jan 12, 2015, 5:15:03 PM
    Author     : arunkumar
--%>
...
<html>
    <head>
        ...
        <title>VEHICLE DETAILS VIEW PAGE</title>
    </head>
...
<tr><td>
  ...
  <h3 style="text-align: center;color: black"> &nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;   &nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;VEHICLE OWNER'S DETAILS</h3>

        <br><br></td></tr>

<tr><td>  <form action="vehicle_details" method="POST">
