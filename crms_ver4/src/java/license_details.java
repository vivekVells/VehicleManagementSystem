 ...
 * @author arunkumar
 */
public class license_details extends HttpServlet {
...
"             </div></td></tr>"); Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
            con = DriverManager.getConnection("jdbc:odbc:crms_ver4_db", "dd", "dd");
            Statement st = con.createStatement();
                        DateFormat dateFormat = new SimpleDateFormat("dd-MM-yyyy");
                          
String query1="select * from user_details_table";               

ResultSet rs1 = st.executeQuery(query1);
              
              // ResultSet rs;
                    out.println("<tr><td><center><h2>LICENSE RENEWAL DETAILS</h2></center></td></tr>");
            ...
            out.println("</tr>");  do
               {
                  ...
                  //  out.println("<td>"+rs1.getString("DOB")+"</font></td>");
                   ...
                   // out.println("<td>"+rs1.getString("LTYPE_")+"</font></td>");
                   // out.println("<td>"+rs1.getString("AMOUNT_")+"</font></td>");
