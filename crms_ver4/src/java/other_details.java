 ...
 * @author arunkumar
 */
public class other_details extends HttpServlet {
...
String query1="select * from other_servlet";               
ResultSet rs1 = st.executeQuery(query1);
              
              // ResultSet rs;
 out.println("<tr><td><center><h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;OTHER ISSUE DETAILS</h3></center></td></tr>");
           ...
           out.println("<table width=\"100%\" cellpadding=\"5\" cellspacing=\"5\">"); 
            ...
            out.println("<th style='text-align: left'>ISSUE TYPE</th>");
            out.println("<th style='text-align: left'>COMMENT</th>");
            ...
            out.println("</tr>");    do
               {
                    ...
                    out.println("<td>"+rs1.getString("ISSUE_TYPE")+"</font></td>");
                    out.println("<td>"+rs1.getString("COMMENT")+"</font></td>");
