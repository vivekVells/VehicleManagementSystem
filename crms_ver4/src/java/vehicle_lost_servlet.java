 ...
 */
public class vehicle_lost_servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(cookies!=null)
        {
           ...
           if(cookies[i].getName().equals("id1")){
               ...
               String dt=request.getParameter("datelost");
...
String query = "insert into vehicle_lost_table(REG_ID,VEHICLE_NO,TYPE,DATE_LOST,CONTACT_NO)" + "values('" + id + "','" + vno +"','" + type + "','" + dt + "','" + ct + "')";
...
"             </div></td></tr>");
   out.println("<tr><td><center><h3> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;VEHICLE LOST STATUS</h3></center></td></tr>");
