 ...
 * @author arunkumar
 */
public class feedback_view_servlets extends HttpServlet {
...
"             </div></td></tr>");  try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>feedback_view</title>");            
            out.println("</head>");
            out.println("<body >");
            ...
            Statement st = con.createStatement();
                       ...
                       // String query2="select * from user_details_table";
                        String str=null;
                        
                       String query2 = " select * from user_details_table WHERE FEEDBACK IS NOT NULL";
                         
                       ResultSet rs2 = st.executeQuery(query2);

                    out.println("<tr><td><center><h2>FEEDBACK DETAILS</h2></center></td></tr>");

               boolean check1=rs2.next();
            ...
            out.println("<tr>");
          //  out.println("<th style='text-align: left';font-weight: bold>REG ID</th>");
          ...
          //  out.println("<th style='text-align: left'>ADDRESS</th>");
            ...
            out.println("<th style='text-align: left'>FEEDBACK</th>");
           // if(val==null)
            {
            out.println("</tr>");   do
               {
                    out.println("<tr>");
                    out.println("<td>"+rs2.getString("REG_ID")+"</font></td>");
                   
                     out.println("<td>"+rs2.getString("REG_NAME")+"</font></td>");
                    
                   out.println("<td>"+rs2.getString("MOBILE_NO")+"</font></td>");
                    out.println("<td>"+rs2.getString("FEEDBACK") +"</font></td>");
            ...
            out.println("</table>");
               ...
               out.println("<br>");
               out.println("<center><br><a href='admin_login.jsp' >Go Back</a></center>");
                 out.println("</body>");
            out.println("</html>");
        }
